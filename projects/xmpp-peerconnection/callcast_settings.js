    ...
    switch (server) {
        ...
        case 'dnle.gocast.it':
            this.privPopulate({ CALLCAST_XMPPSERVER: 'dnle.gocast.it',
                            ...
                            MAC_DL_URL: 'https://dnle.gocast.it/downloads/GoCastPlayer.pkg',
                            WIN_DL_URL: 'https://dnle.gocast.it/downloads/GoCastPlayer.msi', // todo, link in index.html is used, switch to using this value
                            LIN_64_DL_URL: 'https://dnle.gocast.it/downloads/GoCastPlayer_x86_64.tar.gz',
                            LIN_32_DL_URL: 'https://dnle.gocast.it/downloads/GoCastPlayer_i686.tar.gz',
                            MAX_PUBCHAT_SECONDS: 300
                            });
            break;
