...
./configure --target=generic-gnu $COMMON_CONFIG > /dev/null

echo "Generate Generic source list."
make clean > /dev/null
rm -f libvpx_srcs.txt
make libvpx_srcs.txt target=libs $COMMON_CONFIG > /dev/null
convert_srcs_to_gypi libvpx_srcs.txt ../../libvpx_srcs_generic.gypi
