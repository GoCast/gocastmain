...
#if !defined(WEBRTC_LINUX) && !defined(WEBRTC_MAC_INTEL) && !defined(MAC_IPHONE)
        EXPECT_EQ(0,
...
#if !defined(WEBRTC_MAC_INTEL) && !defined(MAC_IPHONE) // these functions will return -1
...
#if !defined(WEBRTC_MAC_INTEL) && !defined(MAC_IPHONE)
