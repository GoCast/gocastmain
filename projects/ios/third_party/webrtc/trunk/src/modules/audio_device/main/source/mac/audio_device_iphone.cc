...
//static char* getOSSError(OSStatus error)
//{
//    char str[1024];
//    
...
WebRtc_Word32 AudioDeviceIPhone::SpeakerVolumeIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SpeakerVolumeIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetSpeakerVolume(WebRtc_UWord32 volume)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetSpeakerVolume not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SpeakerVolume(WebRtc_UWord32& volume) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SpeakerVolume not supported yet on this platform");
    volume = 255;   //Between 0 to 255
    return -1;
}

//Not supported on Mac, won't support on iPhone
                                               ...
                                               WebRtc_UWord16 volumeRight)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetWaveOutVolume not supported on this platform");
    
    return -1;
}

    //Not supported on Mac, won't support on iPhone
WebRtc_Word32 AudioDeviceIPhone::WaveOutVolume(WebRtc_UWord16& volumeLeft,
                              WebRtc_UWord16& volumeRight) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  WaveOutVolume not supported on this platform");
    return -1;
}
...
WebRtc_Word32 AudioDeviceIPhone::MaxSpeakerVolume(WebRtc_UWord32& maxVolume) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MaxSpeakerVolume not supported yet on this platform");
    
    maxVolume = 255;    //Between 0 and 255
...
WebRtc_Word32 AudioDeviceIPhone::MinSpeakerVolume(WebRtc_UWord32& minVolume) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MinSpeakerVolume not supported yet on this platform");
    
    minVolume = 0;      //Between 0 and 255
...
AudioDeviceIPhone::SpeakerVolumeStepSize(WebRtc_UWord16& stepSize) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SpeakerVolumeStepSize not supported yet on this platform");
    
    stepSize = 25;  //Assume 10 steps
...
WebRtc_Word32 AudioDeviceIPhone::SpeakerMuteIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SpeakerMuteIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetSpeakerMute(bool enable)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetSpeakerMute not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SpeakerMute(bool& enabled) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SpeakerMute not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::MicrophoneMuteIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneMuteIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetMicrophoneMute(bool enable)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetMicrophoneMute not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::MicrophoneMute(bool& enabled) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneMute not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::MicrophoneBoostIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneBoostIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetMicrophoneBoost(bool enable)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetMicrophoneBoost not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::MicrophoneBoost(bool& enabled) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneBoost not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::StereoRecordingIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  StereoRecordingIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetStereoRecording(bool enable)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetStereoRecording not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::StereoPlayoutIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  StereoPlayoutIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetStereoPlayout(bool enable)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetStereoPlayout not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::MicrophoneVolumeIsAvailable(bool& available)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneVolumeIsAvailable not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetMicrophoneVolume(WebRtc_UWord32 volume)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetMicrophoneVolume not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::MicrophoneVolume(WebRtc_UWord32& volume) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneVolume not supported yet on this platform");
...
AudioDeviceIPhone::MaxMicrophoneVolume(WebRtc_UWord32& maxVolume) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MaxMicrophoneVolume not supported yet on this platform");
...
AudioDeviceIPhone::MinMicrophoneVolume(WebRtc_UWord32& minVolume) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MinMicrophoneVolume not supported yet on this platform");
...
AudioDeviceIPhone::MicrophoneVolumeStepSize(WebRtc_UWord16& stepSize) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  MicrophoneVolumeStepSize not supported yet on this platform");
...
WebRtc_Word16 AudioDeviceIPhone::PlayoutDevices()
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  PlayoutDevices not supported yet on this platform");
    ...
    WebRtc_Word8 guid[kAdmMaxGuidSize])
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  PlayoutDeviceName not supported yet on this platform");
    ...
    WebRtc_Word8 guid[kAdmMaxGuidSize])
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  RecordingDeviceName not supported yet on this platform");
...
WebRtc_Word16 AudioDeviceIPhone::RecordingDevices()
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  RecordingDevices not supported yet on this platform");
...
WebRtc_Word32 AudioDeviceIPhone::SetRecordingDevice(WebRtc_UWord16 index)
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  SetRecordingDevice not supported yet on this platform");
...
//Not supported on Mac, won't support on iPhone
WebRtc_Word32 AudioDeviceIPhone::SetRecordingDevice(AudioDeviceModule::WindowsDeviceType /*device*/)
{
    WEBRTC_TRACE(kTraceError, kTraceAudioDevice, _id,
                 "WindowsDeviceType not supported");
...
WebRtc_Word32 AudioDeviceIPhone::CPULoad(WebRtc_UWord16& /*load*/) const
{
    ...
    WEBRTC_TRACE(kTraceWarning, kTraceAudioDevice, _id,
                 "  CPULoad not supported yet on this platform");
