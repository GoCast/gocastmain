 ...
 *  @param sessionKey The actual session key (access token) for the user who we are attempting to log in
 */
Strophe.Connection.prototype.facebookConnect = function (jid, callback, wait, hold, apiKey, secretKey, accessToken){
	this.jid = jid;
...
//RMW    this.sessionKey = accessToken;
