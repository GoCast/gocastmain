...
(function($) { 
    var JFMFS = function(element, options) {
        ...
        elem.html(
            ...
            "        <span class='jfmfs-title'>" + settings.labels.filter_title + " </span><input type='text' id='jfmfs-friend-filter-text' placeholder='" + settings.labels.filter_default + "'/><button id='done'>DONE</button>" +
        ...
        $('#done', elem).click(options.close_window);
