	...
	<div id="page-header">
		<div class="headerbar">
			...
			<div id="site-description">
				<a href="./index.php" title="Board index" id="logo"><img src="/images/small-logo.png" width="" height="" alt="" style="margin-top: -8px"></a>
				<h1><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?></h1>
        <p><a href="/" style="color: white; text-decoration: underline">Go back to main site.</a></p>
