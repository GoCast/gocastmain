...
//    gc = new GoCastJS.gcEdit({});   // Invalid start.
    ...
    fs = new GoCastJS.gcFileShare({domLocation: $('#spot2').get(0), nick: Callcast.nick, number: 1002, type: 'gcEdit', networkObject: Callcast,
...
/*
    ...
    gc = new GoCastJS.gcEdit({domLocation: $('#spot1')[0], nick: Callcast.nick, number: 1001, type: 'gcEdit', networkObject: Callcast,
                                tinyIcon: '/images/logo.png', icon: '/images/logo.png',
                                enabledDesc: 'Edit text documents collaboratively', disabledDesc: 'Cannot edit at this time.'});
