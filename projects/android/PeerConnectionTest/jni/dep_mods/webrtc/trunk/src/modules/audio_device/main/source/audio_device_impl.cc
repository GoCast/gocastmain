...
static AudioDeviceGeneric* pTheAndroidAudioDevice = NULL;
#endif
...
WebRtc_Word32 AudioDeviceModuleImpl::CreatePlatformSpecificObjects()
{
    ...
    {
        if(NULL == pTheAndroidAudioDevice)
        {
            ...
            pTheAndroidAudioDevice = ptrAudioDevice;
        }
        else
        {
            ptrAudioDevice = pTheAndroidAudioDevice;
        }
    }
