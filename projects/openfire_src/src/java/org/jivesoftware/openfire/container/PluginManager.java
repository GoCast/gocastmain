...
public class PluginManager {
    ...
    private void loadPlugin(File pluginDir) {
        ...
        if (XMPPServer.getInstance().isSetupMode() && !(pluginDir.getName().equals("admin"))) {
            Log.error("PluginManager: Loading plugin " + pluginDir.getName());
            return;
        }
        ...
        try {
            ...
            if (pluginConfig.exists()) {
                ...
                // Log.error("LOAD PLUGIN:"+pluginName+":"+pluginDir);
                ...
                {
                    Log.error("PluginManager:NO WebXML:"+pluginName+":"+pluginDir+"web"+File.separator + "WEB-INF" + File.separator + "web.xml");
                }
                ...
                {
                    Log.error("PluginManager:NO custom webXML:"+pluginName+":"+pluginDir+"web"+File.separator + "WEB-INF" + File.separator + "web-custom.xml");
                }
